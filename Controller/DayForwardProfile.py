...
class DayForwardProfile(ClickableProfile):
    """
    ...
    def onProfileClicked(self):
        """
        Pulls the data from the day after the current day (if existent) and changes the chart.
        
        @rtype: None
        """
        if self.data.timeDays > 0:
    ...
    def setupScreenPosition(self, viewInstance):
        ...
        @rtype: None
        """
        self.panelStartX = viewInstance.chartStartX + 0.76 * width
